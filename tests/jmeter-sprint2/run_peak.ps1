...
Write-Host "WARNING: PEAK profile generates concurrent load against the deployed shared environment." -ForegroundColor Yellow
...
$jtl = "artifacts\peak_$stamp.jtl"
$html = "artifacts\peak_html_$stamp"

Write-Host "Running peak profile..." -ForegroundColor Cyan
Write-Host "Threads=25, Ramp=15s, Loops=20, Target response <= 300ms"
